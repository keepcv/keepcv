...
describe("the OpenAPI document", () => {
  ...
  it("describes every route the API answers, from the same schemas", async () => {
    ...
    expect(Object.keys(document.paths).sort()).toEqual([
      ...
      "/v1/records/{id}/usage",
      "/v1/resume-entries",
      "/v1/resume-entries/{id}",
      "/v1/resume-entries/{id}/restore",
      "/v1/resume-entry-points",
      "/v1/resume-entry-points/{id}",
      "/v1/resume-entry-points/{id}/restore",
      "/v1/resume-sections",
      "/v1/resume-sections/{id}",
      "/v1/resume-sections/{id}/restore",
      "/v1/resume-snapshots",
      "/v1/resume-snapshots/{id}",
      "/v1/resume-snapshots/{id}/restore",
      "/v1/resume-versions",
      ...
      "/v1/role-profiles",
      "/v1/role-profiles/{id}",
      "/v1/role-profiles/{id}/apply",
      "/v1/role-profiles/{id}/restore",
      "/v1/role-profiles/{id}/tags",
      "/v1/role-profiles/{id}/tags/{tagId}",
      "/v1/saved-filters",
      "/v1/saved-filters/{id}",
      "/v1/saved-filters/{id}/restore",
      "/v1/store",
      "/v1/tags",
      "/v1/tags/{id}",
      "/v1/tags/{id}/merge",
